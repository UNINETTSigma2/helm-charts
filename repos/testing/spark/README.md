...
### Advanced
This application creates an [Apache Spark](https://github.com/UninettSigma2/helm-charts/tree/master/repos/testing/spark) cluster using the following Dockerfile:
  - [uninettSigma2/jupyter-spark](https://github.com/UninettSigma2/helm-charts-dockerfiles/tree/c641e55/jupyter-spark/Dockerfile)
